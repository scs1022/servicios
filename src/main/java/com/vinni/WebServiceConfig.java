...
public class WebServiceConfig {
    ...
    public Endpoint usuarioEndpoint() {
        ...
        Endpoint endpoint = Endpoint.publish("http://0.0.0.0:8081/usuarios", soapImplementacion);
        //Endpoint endpoint = Endpoint.publish("https://serviciossoap.azurewebsites.net/usuarios", soapImplementacion);
        //Endpoint endpoint = Endpoint.publish("https://servicios-r7yq.onrender.com/usuarios", soapImplementacion);
